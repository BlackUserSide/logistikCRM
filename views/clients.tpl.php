                        ...
                        <tbody>
                            ...
                            <?php foreach ($pageData['getDataComp'] as $key => $val) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="/cabinet/cardComp?id=<?php echo $val['id'] ?>"><?php echo $val['nameCompany'] ?></a>
                                    </td>
                                    <td>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($pageData['getDataCar'] as $key => $val) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="/cabinet/cardComp?id=<?php echo $val['id'] ?>"><?php echo $val['nameDriver'] ?></a>
                                    </td>
                                    <td>
                    ...
                    <table class="table-wrapper" data-page-length='5'>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($pageData['getDataRoutes'] as $key => $val) { ?>
                                <tr>
                                    <td>
                                        <a href="/cabinet/cardComp?id=<?php echo $val['id'] ?>"><?php echo $val['id'] ?></a>
                                    </td>
                                    <td>
